          ...
          <div className="flex xl:flex-row flex-col justify-center items-center m-3">
            <div>
              ...
              <button onClick={handleServiceClick}>
                <div className="xl:w-[600px] xl:mr-5 w-full h-full p-5 border-2 border-stone-300 rounded-lg hover:border-[#EF7970] cursor-pointer group relative">
                  <img
                  ...
                  <ArrowRightIcon className="h-6 w-6 group-hover:text-stone-100 group-hover:border-2 group-hover:border-[#EF7970] group-hover:rounded-full absolute group-hover:bg-[#EF7970] right-3 bottom-3 transition-all duration-200" />
                </div>
              </button>
            </div>
            ...
            <div className="flex flex-col items-center">
              <button onClick={handleWorkClick}>
                <div className="lg:m-1 mt-5 mb-5 p-5 border b-2 border-stone-300 rounded-lg xl:max-w-[250px] hover:border-[#EF7970] cursor-pointer group relative">
                  <img
                  ...
                  <ArrowRightIcon className="h-6 w-6 xl:h-5 xl:w-5 group-hover:text-stone-100 group-hover:border-2  group-hover:border-[#EF7970] group-hover:rounded-full absolute group-hover:bg-[#EF7970] right-3 bottom-3 transition-all duration-200" />
                </div>
              </button>

              <button onClick={handleReferencesClick}>
                <div className="p-5 border b-2 border-stone-300 rounded-lg xl:max-w-[250px] hover:border-[#EF7970] pointercursor- group relative">
                  <img
